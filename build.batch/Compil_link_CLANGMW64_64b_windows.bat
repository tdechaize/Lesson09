...
set "CFLAGS=-O2 -m64"
clang %CFLAGS% -D NDEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
clang -m64 -s -L %LIB% objCLANGMW64\Release\%NAME_APPLI%.o objCLANGMW64\Release\%NAME_APPLI%.res -o binCLANGMW64\Release\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -O0 -g"
clang %CFLAGS% -D DEBUG -D _DEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -L %LIB% objCLANGMW64\Debug\%NAME_APPLI%.o objCLANGMW64\Debug\%NAME_APPLI%.res -o binCLANGMW64\Debug\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
clang %CFLAGS% -D NDEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
clang -m64 -mwindows -s -L %LIB% objCLANGMW64\Release\%NAME_APPLI%.o objCLANGMW64\Release\%NAME_APPLI%.res -o binCLANGMW64\Release\%NAME_APPLI%.exe -Wl,--subsystem,windows -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -O0 -g"
clang %CFLAGS% -D DEBUG -D _DEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -mwindows -L %LIB% objCLANGMW64\Debug\%NAME_APPLI%.o objCLANGMW64\Debug\%NAME_APPLI%.res -o binCLANGMW64\Debug\%NAME_APPLI%.exe -Wl,--subsystem,windows -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binCLANGMW64\Release\lib%NAME_APPLI%.a objCLANGMW64\Release\%NAME_APPLI%.o
clang -m64 -o binCLANGMW64\Release\%NAME_APPLI%.lib objCLANGMW64\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m64 -O0 -g"
clang %CFLAGS% -D DEBUG -D _DEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
REM windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
ar ru binCLANGMW64\Debug\lib%NAME_APPLI%.a objCLANGMW64\Debug\%NAME_APPLI%.o
clang -m64 -o binCLANGMW64\Debug\%NAME_APPLI%.lib objCLANGMW64\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
clang %CFLAGS% -D NDEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
clang -m64 -shared -s -L %LIB% -Wl,--out-implib,binCLANGMW64\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objCLANGMW64\Release\%NAME_APPLI%.o objCLANGMW64\Release\%NAME_APPLI%.res -o binCLANGMW64\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-m64 -O0 -g"
clang %CFLAGS% -D DEBUG -D _DEBUG -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I %INC1% -I %INC2% -o objCLANGMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -shared -L %LIB% -Wl,--out-implib,binCLANGMW64\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objCLANGMW64\Debug\%NAME_APPLI%.o objCLANGMW64\Debug\%NAME_APPLI%.res -o binCLANGMW64\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
