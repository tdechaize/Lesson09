...
set "INC1=%LLVM64%\lib\clang\%CLANG_VERSION%\include"
...
set "LIB1=%LLVM64%\lib\clang\%CLANG_VERSION%\lib\windows"
set "LIB2=C:\Program Files (x86)\Windows Kits\%KIT_WIN_VERSION%\Lib\%KIT_WIN_NUM%\ucrt\x64"
set "LIB3=C:\Program Files (x86)\Windows Kits\%KIT_WIN_VERSION%\Lib\%KIT_WIN_NUM%\um\x64"
set "LIB4=C:\Program Files\Microsoft Visual Studio\%VS_VERSION%\Community\VC\Tools\MSVC\%VS_NUM%\lib\x64"
set "LIB5=C:\Program Files\Microsoft Visual Studio\%VS_VERSION%\Community\VC\Tools\MSVC\%VS_NUM%\lib\x64\store"
...
goto FIN
:DEBCONS
set "CFLAGS=-O0 -m64 -fms-extensions -target x86_64-pc-windows-msvc"
...
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" -L %LIB3% -L %LIB4% -L %LIB5% objCLANGX64\Debug\%NAME_APPLI%.obj objCLANGX64\Debug\%NAME_APPLI%.res -o binCLANGX64\Debug\%NAME_APPLI%.exe -Wl,--subsystem,console -Wl,--pdb= -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang %CFLAGS% -DDEBUG -D_DEBUG -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" objCLANGX64\Debug\%NAME_APPLI%.obj objCLANGX64\Debug\%NAME_APPLI%.res -o binCLANGX64\Debug\%NAME_APPLI%.exe -Wl,--pdb= -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -o binCLANGX64\Debug\%NAME_APPLI%.lib objCLANGX64\Debug\%NAME_APPLI%.obj -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang %CFLAGS% -DNDEBUG -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Release\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -shared -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" -Wl,--out-implib,binCLANGX64\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows -Wl,--pdb= objCLANGX64\Release\%NAME_APPLI%.obj objCLANGX64\Release\%NAME_APPLI%.res -o binCLANGX64\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-O0 -m64 -fms-extensions -target x86_64-pc-windows-msvc -g"
clang %CFLAGS% -DDEBUG -D_DEBUG -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -shared -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" -Wl,--out-implib,binCLANGX64\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows -Wl,--pdb= objCLANGX64\Debug\%NAME_APPLI%.obj objCLANGX64\Debug\%NAME_APPLI%.res -o binCLANGX64\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
