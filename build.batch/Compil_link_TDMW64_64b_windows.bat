...
gcc -m64 -mconsole -s -L"%LIB%" objTDMW64\Release\%NAME_APPLI%.o objTDMW64\Release\%NAME_APPLI%.res -o binTDMW64\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mconsole -L"%LIB%" objTDMW64\Debug\%NAME_APPLI%.o objTDMW64\Debug\%NAME_APPLI%.res -o binTDMW64\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objTDMW64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mwindows -s -L"%LIB%" objTDMW64\Release\%NAME_APPLI%.o objTDMW64\Release\%NAME_APPLI%.res -o binTDMW64\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mwindows -L"%LIB%" objTDMW64\Debug\%NAME_APPLI%.o objTDMW64\Debug\%NAME_APPLI%.res -o binTDMW64\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binTDMW64\Release\lib%NAME_APPLI%.a objTDMW64\Release\%NAME_APPLI%.o
gcc -o binTDMW64\Release\%NAME_APPLI%.lib objTDMW64\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m64 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
REM windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
ar ru binTDMW64\Debug\lib%NAME_APPLI%.a objTDMW64\Debug\%NAME_APPLI%.o
gcc -o binTDMW64\Debug\%NAME_APPLI%.lib objTDMW64\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objTDMW64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -shared -s -L"%LIB%" -Wl,--out-implib,binTDMW64\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objTDMW64\Release\%NAME_APPLI%.o objTDMW64\Release\%NAME_APPLI%.res -o binTDMW64\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-m64 -g -fPIC"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -shared -L"%LIB%" -Wl,--out-implib,binTDMW64\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objTDMW64\Debug\%NAME_APPLI%.o objTDMW64\Debug\%NAME_APPLI%.res -o binTDMW64\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
