...
set "LIB1=C:\Program Files (x86)\Windows Kits\%KIT_WIN_VERSION%\Lib\%KIT_WIN_NUM%\ucrt\x64"
set "LIB2=C:\Program Files (x86)\Windows Kits\%KIT_WIN_VERSION%\Lib\%KIT_WIN_NUM%\um\x64"
set "LIB3=C:\Program Files\Microsoft Visual Studio\%VS_VERSION%\Community\VC\Tools\MSVC\%VS_NUM%\lib\x64"
set "LIB4=C:\Program Files\Microsoft Visual Studio\%VS_VERSION%\Community\VC\Tools\MSVC\%VS_NUM%\lib\x64\store"
...
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link.exe /nologo /subsystem:console /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Release\%NAME_APPLI%.obj objVS2022X64\Release\%NAME_APPLI%.res /out:binVS2022X64\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
:DEBCONS
set "CFLAGS=/nologo /TC /Zi"
cl %CFLAGS% /DDEBUG /D_DEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link.exe /nologo /subsystem:console /debug /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Debug\%NAME_APPLI%.obj objVS2022X64\Debug\%NAME_APPLI%.res /out:binVS2022X64\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
...
cl %CFLAGS% /DNDEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link.exe /nologo /subsystem:windows /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Release\%NAME_APPLI%.obj objVS2022X64\Release\%NAME_APPLI%.res /out:binVS2022X64\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
:DEBAPP
set "CFLAGS=/nologo /TC /Zi"
cl %CFLAGS% /DDEBUG /D_DEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link.exe /nologo /debug /subsystem:windows /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Debug\%NAME_APPLI%.obj objVS2022X64\Debug\%NAME_APPLI%.res /out:binVS2022X64\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
...
set "CFLAGS=/nologo /TC"
cl %CFLAGS% /DNDEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
REM rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
lib /MACHINE:X64 /subsystem:windows /out:binVS2022X64\Release\%NAME_APPLI%.lib objVS2022X64\Release\%NAME_APPLI%.obj 
goto FIN
:DEBLIB
set "CFLAGS=/nologo /TC /Zi"
cl %CFLAGS% /DDEBUG /D_DEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
REM rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
lib /MACHINE:X64 /subsystem:windows /out:binVS2022X64\Debug\%NAME_APPLI%.lib objVS2022X64\Debug\%NAME_APPLI%.obj 
goto FIN
...
cl %CFLAGS% /DNDEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link /DLL /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Release\%NAME_APPLI%.obj objVS2022X64\Release\%NAME_APPLI%.res /out:binVS2022X64\Release\%NAME_APPLI%.dll /IMPLIB:binVS2022X64\Release\%NAME_APPLI%.lib glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
:DEBDLL
set "CFLAGS=/nologo /TC /Zi"
cl %CFLAGS% /DDEBUG /D_DEBUG /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.obj /c src\%NAME_APPLI%.c
rc /I"%INC1%" /I"%INC2%" /I"%INC3%" /I"%INC4%" /FoobjVS2022X64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
link /DLL /debug /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /LIBPATH:"%LIB4%" objVS2022X64\Debug\%NAME_APPLI%.obj objVS2022X64\Debug\%NAME_APPLI%.res /out:binVS2022X64\Debug\%NAME_APPLI%.dll /IMPLIB:binVS2022X64\Debug\%NAME_APPLI%.lib glu32.lib opengl32.lib user32.lib advapi32.lib comdlg32.lib winmm.lib gdi32.lib shell32.lib kernel32.lib
goto FIN
