...
REM ---------------------------------------------------------------------------------------------------
REM
REM		 Compil_link_MINGW32OF_32b_windows.bat : 	Nom de ce batch  
REM
...
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mconsole -s -L"%LIB%" objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m32 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mconsole -L"%LIB%" objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mwindows -s -L"%LIB%" objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m32 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mwindows -L"%LIB%" objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
set "CFLAGS=-O2 -m32"
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
REM windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
ar ru binMINGW32OF\Release\lib%NAME_APPLI%.a objMINGW32OF\Release\%NAME_APPLI%.o
gcc -m32 -o binMINGW32OF\Release\%NAME_APPLI%.lib objMINGW32OF\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m32 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
REM windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
ar ru binMINGW32OF\Debug\lib%NAME_APPLI%.a objMINGW32OF\Debug\%NAME_APPLI%.o
gcc -m32 -o binMINGW32OF\Debug\%NAME_APPLI%.lib objMINGW32OF\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -shared -s -L"%LIB%" -Wl,--out-implib,binMINGW32OF\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-m32 -g -fPIC"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -shared -L"%LIB%" -Wl,--out-implib,binMINGW32OF\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
