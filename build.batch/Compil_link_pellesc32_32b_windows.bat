...
polink /nologo /SUBSYSTEM:CONSOLE /MACHINE:x86 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" objPellesC32\Release\%NAME_APPLI%.obj objPellesC32\Release\%NAME_APPLI%.res /OUT:binPellesC32\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBCONS
set "CFLAGS=/nologo /Tx86-coff  /Ze /c /Zi"
pocc %CFLAGS% /DDEBUG /D_DEBUG /D_WIN32 /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /DEBUG /SUBSYSTEM:CONSOLE /MACHINE:x86 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" objPellesC32\Debug\%NAME_APPLI%.obj objPellesC32\Debug\%NAME_APPLI%.res /OUT:binPellesC32\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
...
pocc %CFLAGS% /DNDEBUG /D_WIN32 /I%INC1% /I%INC2% /FoobjPellesC32\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC32\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /SUBSYSTEM:WINDOWS /MACHINE:x86 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" objPellesC32\Release\%NAME_APPLI%.obj objPellesC32\Release\%NAME_APPLI%.res /OUT:binPellesC32\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBAPP
set "CFLAGS=/nologo /Tx86-coff  /Ze /c /Zi"
pocc %CFLAGS% /DDEBUG /D_DEBUG /D_WIN32 /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /DEBUG /SUBSYSTEM:WINDOWS /MACHINE:x86 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" objPellesC32\Debug\%NAME_APPLI%.obj objPellesC32\Debug\%NAME_APPLI%.res /OUT:binPellesC32\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
...
polib /MACHINE:x86 /out:binPellesC32\Release\%NAME_APPLI%.lib objPellesC32\Release\%NAME_APPLI%.obj
goto FIN
:DEBLIB
set "CFLAGS=/nologo /Tx86-coff /Ze /c /Zi"
pocc %CFLAGS% /DDEBUG /D_DEBUG /D_WIN32 /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
REM porc /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polib /MACHINE:x86 /out:binPellesC32\Debug\%NAME_APPLI%.lib objPellesC32\Debug\%NAME_APPLI%.obj
goto FIN
...
pocc %CFLAGS% /DNDEBUG /D_WIN32 /I%INC1% /I%INC2% /FoobjPellesC32\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC32\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /Dll /MACHINE:x86 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /IMPLIB:binPellesC32\Release\%NAME_APPLI%.lib objPellesC32\Release\%NAME_APPLI%.obj objPellesC32\Release\%NAME_APPLI%.res /OUT:binPellesC32\Release\%NAME_APPLI%.dll glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBDLL
set "FLAGS=/nologo /Tx86-coff /Ze /c /Zi"
pocc %CFLAGS% /DDEBUG /D_WIN32 /D_DEBUG /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /Dll /MACHINE:x86 /DEBUG /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /IMPLIB:binPellesC32\Debug\%NAME_APPLI%.lib objPellesC32\Debug\%NAME_APPLI%.obj objPellesC32\Debug\%NAME_APPLI%.res /OUT:binPellesC32\Debug\%NAME_APPLI%.dll glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
