...
gcc -m64 -mconsole -s -L"%LIB%" objMINGW64WL\Release\%NAME_APPLI%.o objMINGW64WL\Release\%NAME_APPLI%.res -o binMINGW64WL\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -g"
...
gcc -m64 -mconsole -L"%LIB%" objMINGW64WL\Debug\%NAME_APPLI%.o objMINGW64WL\Debug\%NAME_APPLI%.res -o binMINGW64WL\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objMINGW64WL\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW64WL\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mwindows -s -L"%LIB%" objMINGW64WL\Release\%NAME_APPLI%.o objMINGW64WL\Release\%NAME_APPLI%.res -o binMINGW64WL\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mwindows -L"%LIB%" objMINGW64WL\Debug\%NAME_APPLI%.o objMINGW64WL\Debug\%NAME_APPLI%.res -o binMINGW64WL\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binMINGW64WL\Release\lib%NAME_APPLI%.a objMINGW64WL\Release\%NAME_APPLI%.o
gcc -m64 -o binMINGW64WL\Release\%NAME_APPLI%.lib objMINGW64WL\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m64 -g"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
REM windres -J rc -O coff -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
ar ru binMINGW64WL\Debug\lib%NAME_APPLI%.a objMINGW64WL\Debug\%NAME_APPLI%.o
gcc -m64 -o binMINGW64WL\Debug\%NAME_APPLI%.lib objMINGW64WL\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -DNDEBUG -I%INCLUDE% -o objMINGW64WL\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW64WL\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -shared -s -L"%LIB%" -Wl,--out-implib,binMINGW64WL\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objMINGW64WL\Release\%NAME_APPLI%.o objMINGW64WL\Release\%NAME_APPLI%.res -o binMINGW64WL\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-m64 -g -fPIC"
gcc %CFLAGS% -DDEBUG -D_DEBUG -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW64WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -shared -L"%LIB%" -Wl,--out-implib,binMINGW64WL\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objMINGW64WL\Debug\%NAME_APPLI%.o objMINGW64WL\Debug\%NAME_APPLI%.res -o binMINGW64WL\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
